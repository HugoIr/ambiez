...
class CustomCheckBox extends StatefulWidget {
  ...
  const CustomCheckBox({
    ...
    this.checkedFillColor = AmbiezColorsFoundation.primaryColor,
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: widget.shouldShowBorder
              ? (widget.borderColor ?? AmbiezColorsFoundation.primaryColor)
              : (!widget.value
                  ? (widget.borderColor ?? AmbiezColorsFoundation.primaryColor)
                  : Colors.transparent),
          width: widget.shouldShowBorder ? widget.borderWidth ?? 4.0 : 2.0,
        ),
      ),
      child: Icon(
        iconData,
